...
export default function Header() {
  ...
  return (
    <header className="bg-white dark:bg-gray-900 shadow-lg border-b border-gray-200 dark:border-gray-700 sticky top-0 z-50 transition-all duration-300">
      ...
      <div className="bg-orange-600 dark:bg-orange-700 text-white py-2">
      ...
      <div className="container mx-auto px-4 py-3 md:py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            <button
              ...
              className={`font-medium transition-all duration-200 hover:scale-105 transform ${
                activeSection === "home"
                  ? "text-orange-700 dark:text-orange-400 border-b-2 border-orange-700 dark:border-orange-400"
                  : "text-gray-800 dark:text-gray-200 hover:text-orange-700 dark:hover:text-orange-400 hover:border-b-2 hover:border-orange-300 dark:hover:border-orange-600"
              }`}
            >
              {t.nav_home}
            </button>
          ...
          <div className="flex items-center space-x-2">
            ...
            <Button
              size="sm"
              className="hidden md:flex bg-orange-600 hover:bg-orange-700 dark:bg-orange-500 dark:hover:bg-orange-600 hover:scale-105 transform duration-200 text-xs md:text-sm shadow-md hover:shadow-lg transition-all text-white font-medium"
              onClick={() => smoothScrollTo("contact")}
            >
            ...
            {/* Mobile Menu Button */}
            <button
              className="lg:hidden p-2 rounded-md text-gray-700 dark:text-gray-300 hover:text-orange-700 dark:hover:text-orange-400 hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-200"
